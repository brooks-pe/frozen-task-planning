    ...
    <div className="w-full border-b border-[#CDCED6]" style={{ gridColumn: '1 / -1' }}>
      <div className="bg-[#E8F3F9] border-l-[6px] border-l-[#147DB9] px-[24px] py-[24px]">
        ...
        <div className="bg-white rounded-[4px] border border-[#CDCED6]">
          {/* Table Header */}
          <div className="bg-[#f5f5f5] grid border-b-2 border-[#CDCED6] px-[12px] py-[12px]" style={{ gridTemplateColumns: 'repeat(8, minmax(0, 1fr))' }}>
              ...
              <div className="flex items-center justify-end pr-[8px]">
                <div className="relative w-full">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full h-[32px] pl-[20px] pr-[8px] border border-[#B9BBC6] rounded-[4px] font-['Inter:Regular',sans-serif] font-normal text-[14px] text-[#1C2024] text-right placeholder:text-[#80838D] focus:outline-none focus:border-[#147DB9] focus:ring-1 focus:ring-[rgba(20,125,185,0.2)]"
              ...
              <div className="flex items-center pr-[8px]">
                <div className="relative w-full">
                  <select
                    ...
                    className={`w-full h-[32px] pl-[12px] pr-[32px] border border-[#B9BBC6] rounded-[4px] font-['Inter:Regular',sans-serif] font-normal text-[14px] leading-[20px] cursor-pointer appearance-none bg-white ${
